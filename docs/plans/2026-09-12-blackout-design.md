...
3. Question. Planet name and category top-left, lights top-right. Under the
   ...
   "Question 1 of 3" under that. Question in light type. Four full-width
   ...
   explanation then crossfades into the question's slot with a small "Tap
   anywhere to continue" line. A tap anywhere on the screen moves on. Nothing
