...
Plan: article to tagged facts, facts clustered into topics of 10 to 15
questions, a planet draws 6 or 7 from one topic. Multiple-answer format was
built first because it changes the data shape. Not yet built.
